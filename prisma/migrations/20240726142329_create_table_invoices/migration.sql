...
INSERT INTO "new_transactions" ("accountId", "amount", "categoryId", "created_at", "date", "description", "id", "type", "updated_at") SELECT "accountId", "amount", "categoryId", "created_at", "date", "description", "id", "type", "updated_at" FROM "transactions";
